...
namespace Kamishiro.UnityEditor.CopyDynamicBones
{
    ...
    public class Version
    {
        ...
        private const string localver = "akcopydynamicbones_version_local";
        private const string remotever = "akcopydynamicbones_version_remote";
        private const string needUpdate = "akcopydynamicbones_need_update";
...
#pragma warning restore 0618
        ...
        {
            EditorGUILayout.LabelField("Author: " + UIText.author);
